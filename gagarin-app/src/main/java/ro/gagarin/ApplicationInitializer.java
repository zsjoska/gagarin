...
public class ApplicationInitializer {
	...
	List<Group> userGroups = userManager.getUserGroups(admin);
	...
	Group adminGroup = userManager.getGroupByName(adminGroupName);
	userManager.assignUserToGroup(admin, adminGroup);
    }

    private void checkAdminGroup(UserRole adminRole) throws OperationException, DataConstraintException {
	String adminGroupName = cfgManager.getString(Config.ADMIN_GROUP_NAME);
	Group groupByName = userManager.getGroupByName(adminGroupName);
	if (groupByName == null) {
	    ...
	    group.setId(userManager.createGroup(group));
